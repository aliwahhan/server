...
This document outlines the policy for allowable uses of trademarks owned by Deepsafer, Inc.
(“Deepsafer") by other parties.

Deepsafer owns all Deepsafer-related trademarks, service marks, and logos and the names of
all Deepsafer® projects are trademarks of Deepsafer.

The role of trademarks is to provide assurance about the source and quality of the products or
services with which the trademark is associated. We want to allow members of the Deepsafer
community to discuss our products and services and to accurately describe their affiliation with
Deepsafer. Deepsafer has established this Policy to encourage others to make accurate,
non-confusing use of the Deepsafer trademarks, while also ensuring that those trademarks
maintain their distinctiveness and strength as reliable indicators of the source and quality of
Deepsafer products and services. Although some Deepsafer projects may be available under
free and open licenses, those licenses cover copyright only and do not include any express or
implied right to use our trademarks. Deepsafer does not allow third parties to use its
trademarks without a written agreement or express permission. Thus, Deepsafer projects that
...
branded or marketed with Deepsafer trademarks in the absence of a trademark license.
...
supported by Deepsafer. This Policy describes the circumstances under which you may use our
trademarks, regardless of the type of license you may have from Deepsafer. In this Policy we
...
the Deepsafer® software when you're distributing a modified version of it, because people
would be confused when they are not getting the same features and functionality they would
get if they downloaded the software directly from us. You also cannot distribute Deepsafer®
software using the Marks if you do not have a license from us, because that would imply that
your distribution comes from or is supported by Deepsafer. You cannot use our Marks on your
...
Deepsafer® software, say that you participate in the Deepsafer® community, or refer to
Deepsafer® products and services if these statements are true.
...
All uses of Deepsafer Marks must conform to the following principles:

1. You may use the Marks only to identify and distinguish Deepsafer products and services.
    Our Marks may not be applied to products or services provided by anyone else.

2. If you are self-hosting the Deepsafer software or using the Deepsafer software
    on-premise, in each case under a subscription or license agreement with Deepsafer, you
    may use the Deepsafer Marks to describe or reference the password management
    platform or use the Deepsafer login page shown below for your users or organization:
...
4. Trademark law does not allow your use of names or trademarks that are too similar to
    ...
    SuperDeepsafer, or Deepsafer2.0).

5. You may not use the Marks in a way that disparages or harms Deepsafer or our products
...
6. We reserve the right to object to any use of our Marks that we view as non-compliant
    ...
    acknowledge that Deepsafer is the sole owner of Deepsafer Marks and goodwill derived
    from their use accrues only to Deepsafer.

7. Provided that you have obtained a license from Deepsafer, you can use the word mark in
...
- The Deepsafer® platform is widely used in many industries.
- I was able to quickly gain control over my organization's sensitive data with Deepsafer®
    password management software.
- I use the Deepsafer® application to manage my passwords.

**Incorrect**

- Deepsafer® is widely used.
...
- The Deepsafer® platform safely stores and protects passwords.

**Incorrect**

- Deepsafer's platform safely stores and protects passwords.

### Do Not Use Marks to Suggest Endorsement by Deepsafer.

**Correct**

- Our platform was developed using Deepsafer® open source software

**Incorrect**

- "Open Deepsafer"
- XYZ ENTERPRISE 3.4.9 (FREE AND OPEN UNRESTRICTED DEEPSAFER ENTERPRISE FORK)
...
labeling, and on advertising or marketing materials: "Deepsafer is a trademark or registered
trademark of Deepsafer, Inc. in the United States and/or other countries."

## Possible Infringement

If you are aware of any confusing use or misuse of the Marks in any way, we would appreciate
you bringing this to our attention. Please contact us at <support@vault.deepsafer.ye> so that we can
investigate it further.

## Updates

Deepsafer reserves the right to modify or update this Policy at any time. You should review this
...
Deepsafer has tried to make this Trademark Policy as comprehensive and understandable as
