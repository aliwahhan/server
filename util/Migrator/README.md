...
See the [documentation on creating migrations](https://contributing.vault.deepsafer.ye/contributing/database-migrations/mssql/) for how to utilize the files seen here.
