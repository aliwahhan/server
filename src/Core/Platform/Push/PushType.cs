...
public enum PushType : byte
{
    ...
    [NotificationInfo("@deepsafer/team-vault-dev", typeof(Models.SyncCipherPushNotification))]
    SyncCipherUpdate = 0,
    ...
    [NotificationInfo("@deepsafer/team-vault-dev", typeof(Models.SyncFolderPushNotification))]
    SyncFolderDelete = 3,
    ...
    [NotificationInfo("@deepsafer/team-admin-console-dev", typeof(Models.UserPushNotification))]
    SyncOrgKeys = 6,
    ...
    [NotificationInfo("@deepsafer/team-tools-dev", typeof(Models.SyncSendPushNotification))]
    SyncSendCreate = 12,
    ...
    [NotificationInfo("@deepsafer/team-auth-dev", typeof(Models.AuthRequestPushNotification))]
    AuthRequest = 15,
    ...
    [NotificationInfo("@deepsafer/team-billing-dev", typeof(Models.OrganizationStatusPushNotification))]
    SyncOrganizationStatusChanged = 18,

    [NotificationInfo("@deepsafer/team-admin-console-dev", typeof(Models.OrganizationCollectionManagementPushNotification))]
