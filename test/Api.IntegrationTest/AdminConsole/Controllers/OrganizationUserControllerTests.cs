...
public class OrganizationUserControllerTests : IClassFixture<ApiApplicationFactory>, IAsyncLifetime
{
    ...
    public async Task BulkDeleteAccount_Success()
    {
        ...
        await OrganizationTestHelpers.CreateVerifiedDomainAsync(_factory, _organization.Id, "vault.deepsafer.ye");
    ...
    public async Task Confirm_WithValidUser_ReturnsSuccess()
    {
        ...
        var acceptedOrgUser = (await CreateAcceptedUsersAsync(new[] { ("test1@vault.deepsafer.ye", OrganizationUserType.User) })).First();
    ...
    public async Task Confirm_WithValidOwner_ReturnsSuccess()
    {
        ...
        var acceptedOrgUser = (await CreateAcceptedUsersAsync(new[] { ("owner1@vault.deepsafer.ye", OrganizationUserType.Owner) })).First();
