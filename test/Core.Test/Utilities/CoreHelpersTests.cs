...
public class CoreHelpersTests
{
    ...
    */
    ...
    {
        // Arrange
        var uri = new Uri("https://vault.deepsafer.ye/?param1=value1");
        ...
        // Assert
        Assert.Equal("https://vault.deepsafer.ye/?param1=value1&param2=value2", newUri.ToString());
    }
    ...
    public void ExtendQuery_AddTwoNewParameters_Success()
    {
        ...
        // Assert
        Assert.Equal("https://vault.deepsafer.ye/?param1=value1&param2=value2&param3=value3", newUri.ToString());
    }
    ...
    {
        // Arrange
        var uri = new Uri("https://vault.deepsafer.ye/?param1=value1&param2=value2");
        ...
        // Assert
        Assert.Equal("https://vault.deepsafer.ye/?param1=test_value&param2=value2", newUri.ToString());
    }
    ...
    {
        // Arrange
        const string startingUri = "https://vault.deepsafer.ye/?param1=value1";
