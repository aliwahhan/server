...
public class StaticStoreTests
{
    ...
    public void StaticStore_GlobalEquivalentDomains_OnlyAsciiAllowed()
    {
        ...
        // URL would lead you somewhere different. There is an opening for an attacker to contribute to Deepsafer with a
        // url update that could be missed in code review and then if they got a user to that URL Deepsafer could
